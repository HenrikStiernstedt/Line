...
{
    /// <summary>
    /// Entire class copied from http://dotnetbyexample.blogspot.se/2013/09/utility-classes-to-check-if-lines-andor.html
    /// It checks if a line intersects with another line, and returns the intersection point.
    /// Not exactly what I need, but good enough for a start. 
    /// </summary>
    public class LineF
  {
